...
let myPArray: string[] = ["Makkah", "Medinah", "Spain", "Japan", "Turkey"];
console.log(myPArray);
let Sorted_myPArray = myPArray.slice().sort((a, b) => a.localeCompare(b));
console.log("Original Array : ", myPArray);
console.log("Sorted Array : ", Sorted_myPArray);
let RSorted_myPArray = myPArray.slice().sort((a, b) => b.localeCompare(a));
console.log("Original Array : ", myPArray);
...
RSorted_myPArray.sort((a, b) => a.localeCompare(b));
console.log(RSorted_myPArray);
RSorted_myPArray.sort((a, b) => b.localeCompare(a));
console.log(RSorted_myPArray);